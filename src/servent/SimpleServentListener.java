			...
			try {
				...
				synchronized (AppConfig.colorLock) {
					for (SnapshotIndicator snapshotIndicator : clientMessage.getSnapshotIndicators()) {
						if (snapshotIndicator.getSnapshotId() > AppConfig.initiators.get(snapshotIndicator.getInitiatorId())) {
							...
							lyFinancialManager.markerEvent(
									snapshotIndicator.getInitiatorId(), snapshotCollector,
									snapshotIndicator.getSnapshotId() ,clientMessage.getOriginalSenderInfo());
							break;
						}
					}
				}
